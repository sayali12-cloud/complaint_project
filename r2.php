...
{
  $check_emailid="select * from register_db where emailid='$emailid'";
  ...
  if($r>0){  
    ...
    $check_fname="select * from register_db where fullname='$uname'";
  $data=mysqli_query($connec,$check_name);
  $r=mysqli_fetch_array($data);
  if($r>0){  
